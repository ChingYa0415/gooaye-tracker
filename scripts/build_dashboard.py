        ...
        <div class="panel">
          ...
          <div class="table-wrap">
            <table>
              <thead>
                <tr>
                  <th aria-sort="none"><button class="sort-header" type="button" data-sort-key="name" aria-label="依標的排序"><span>標的</span><span class="sort-indicator" aria-hidden="true"></span></button></th>
                  <th aria-sort="none"><button class="sort-header" type="button" data-sort-key="kind" aria-label="依類型排序"><span>類型</span><span class="sort-indicator" aria-hidden="true"></span></button></th>
